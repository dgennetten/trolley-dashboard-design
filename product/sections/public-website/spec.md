...
- Visit the Support Us page to view membership levels and benefits, open the new member signup modal (name, address, email, phone, membership level, payment via PayPal Braintree Drop-in UI), donate via the Braintree-powered donation flow, learn about volunteering, and view car card advertising info
...
- Support Us: membership tier comparison cards with benefits list, prominent "Join Now" button opening a signup modal with PayPal Braintree Drop-in UI (credit/debit card, PayPal, Venmo), a "Donate" button launching the Braintree donation flow, and additional support options (Volunteer, Advertise, Charter) as action cards
