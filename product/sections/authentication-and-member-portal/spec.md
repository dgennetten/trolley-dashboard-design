...
- Renew membership via PayPal Braintree Drop-in UI with automatic confirmation — handles both annual renewal and past-due renewal; supports credit/debit card, PayPal, and Venmo
...
- Renewal modal: shows current tier with price, optional upgrade selector, PayPal Braintree Drop-in UI (card, PayPal, Venmo), and confirmation state
