import type { ProcessingFeeConfig } from '@/../product/sections/authentication-and-member-portal/types'

/** Compute the processing fee a member can opt to cover, rounded to cents.
