...
- **SECTION_NAME** = [Human-readable name, e.g., "Public Website" or "Membership Admin Dashboard"]
- **SECTION_ID** = [Folder name in sections/, e.g., "public-website" or "membership-admin-dashboard"]
